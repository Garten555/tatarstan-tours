...
/**
 * Подбирает гида на слот с учётом конфликтов, фиксированных выходных и (опционально) ротации.
 * Сначала уважает ротацию; если свободных нет — ослабляет только ротацию, не фиксированные выходные.
 */
